...
drop database "BDTalca";

create database "BDTalca" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C' LC_CTYPE = 'C';

alter database "BDTalca" owner to postgres;
...
insert into EstacionDeServicio values ('Talca', 0.01, 400, 400, 400, 400, 400);
insert into Surtidor values ('Talca_93', '93', 400, 0, 200, 0, 'Talca'),
							('Talca_95', '95', 400, 0, 200, 0, 'Talca'),
							('Talca_97', '97', 400, 0, 200, 0, 'Talca'),
							('Talca_Diesel', 'petroleo', 400, 0, 200, 0, 'Talca'),
							('Talca_Kerosene', 'kerosene', 400, 0, 200, 0, 'Talca');
